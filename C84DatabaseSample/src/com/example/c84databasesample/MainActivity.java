...
public class MainActivity extends Activity {
    ...
    private static final String[] NAMES = { "たろー", "じろー", "ぽん吉", "かなこ", "花子", "ゆうた", "りょうた",
            "まえけん", "ほりけん", "きんたろう" };
    ...
    public void createSampleData() {
        ...
        try {
            ...
            Log.d("Test", "WAL :"+db.isWriteAheadLoggingEnabled());
            db.beginTransaction();
            ...
            start = printTimeLog("setTransactionSuccessful", start, System.nanoTime());
        } finally {
            db.endTransaction();
